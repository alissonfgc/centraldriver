        ...
        <div class="row align-items-center">
            <div class="col-md-10 mx-auto col-lg-5">
                <form class="p-4 p-md-5 border rounded-3 bg-dark needs-validation" novalidate>
                  ...
                  <div class="form-floating mb-3">
                    <input type="password" class="form-control" id="inputPassword" id="validationCustom02" placeholder="Senha" required>
                    <label for="inputPassword" id="validationCustom02">Senha</label>
                    <div class="invalid-feedback">
                    Insira uma senha valida.
                  </div>
                  </div>
                  <div class="form-floating mb-3">
                    <a href="recuperarSenha.php" class="link-light">Esqueceu sua senha?</a>
                  </div>
                  <button class=" w-100 btn btn-lg btn-success mb-3" type="submit">Entrar</button>
                  <div class="form-floating mb-3">
                    <a href="cadastro.php" class="link-light">Não tenho cadastro</a>
                  </div>
                </form>
            </div>
        </div>
