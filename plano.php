...
<head>
    ...
    <title>Planos | Central Driver</title>
</head>
        ...
        <div class="row align-items-center">
            <div class="col-md-6 mx-auto col-lg-4">
                <div class="card text-center shadow-sm border-primary">
                    ...
                    <div class="card-body">
                        <h1 class="card-title pricing-card-title">R$10<small class="text-muted fw-light">/ano</small></h1>
                        <ul class="list-unstyled mt-3 mb-4">
                            <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check" viewBox="0 0 16 16">
                                ...
                                </svg>Todos os recursos oferecidos pelo app
                            </li>
                            <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check" viewBox="0 0 16 16">
                                <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z" />
                                </svg>Suporte via WhatsApp
                            </li>
                            <li>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check" viewBox="0 0 16 16">
                                <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z" />
                                </svg>Atualizado frequentemente
                            </li>
                        </ul>
                        <hr />
                        <p class="card-text text-muted">*Atualmente o pagamento é feito somente via pix.</p>
                        <a href="pagamento.php" class="w-100 btn btn-primary">
