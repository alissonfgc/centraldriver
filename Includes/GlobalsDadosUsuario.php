...
<strong>Senha:</strong> <?php echo $_SESSION['senha']; ?><br>
<strong>Confirmado:</strong> <?php echo $_SESSION['confirmado']; ?><br>
<strong>Pago:</strong> <?php echo $_SESSION['pago']; ?><br>
<br>
<h2>Tabela metas</h2>
        <strong>metas_id:</strong> <? echo $DMFetch['metas_id']; ?><br>
...
<?php 
    if(empty($DMFetch)){
        echo "O Arrey DMFetch está vazio";
        #Neste caso os dados não irão para a pagina.
        
    }else if(!empty($DMFetch)){
        echo "<h2>Tabela metas</h2>
        <strong>metas_id:</strong> $DMFetch['metas_id']; <br>
        <strong>meta_sem:</strong> <?php echo $DMFetch['meta_sem']; ?><br>
        <strong>meta_men:</strong> <?php echo $DMFetch['meta_men']; ?><br>
        <strong>FK_usuario_id:</strong> <?php echo $DMFetch['FK_usuario_id']; ?><br>
        <br>";
